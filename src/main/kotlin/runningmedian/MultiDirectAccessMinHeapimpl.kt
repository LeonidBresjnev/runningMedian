...
class MultiDirectAccessMinHeapimpl(val minHeap: Boolean=true):
    MultiDirectAccessMinHeap
{
    ...
    private fun removeByAge(age: Double): Boolean {
        //remove(T)
        validate()
    ...
    override fun removeSmallAges(age: Double): Boolean {
    ...
    override fun poll(): Triple<Double,Double,Long>? {
